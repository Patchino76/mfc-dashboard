...
import TreeStructureSST from "./TreeStructureSST";
...
const SstDowntimesPage = () => {
  ...
  const handleTreeSelect = (id: string) => {
    setSelectedTag(tags[Math.floor(Math.random() * 4)]); // just random int for now
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="grid grid-cols-[350px_1fr] gap-3">
        <div>
          <TreeStructureSST onSelect={handleTreeSelect} />
        </div>
        <Card>
          <CardHeader>
